        ...
        <form action="{{ route('shop.update', ['id' => $shop->id]) }}" method="POST" enctype="multipart/form-data" class="create__form">
            ...
            <div class="form__inner">
                ...
                <div class="form__item">
                    <input type="text" name="name" id="name" class="input__item" value="{{ old('name', $shop->name) }}"/>
            ...
            <div class="form__inner">
                ...
                <div class="form__item">
                    <select name="area_id" id="area_id" class="select__item">
                        <option value="" disabled {{ old('area_id', $shop->area_id) ? '' : 'selected' }}>-- エリアを選択 --</option>
            ...
            <div class="form__inner">
                ...
                <div class="form__item">
                    <select name="genre_id" id="genre_id" class="select__item">
                        <option value="" disabled {{ old('genre_id', $shop->genre_id) ? '' : 'selected' }}>-- ジャンルを選択 --</option>
            ...
            <div class="form__inner">
                ...
                <div class="form__item">
                    <input type="text" name="address" id="address" class="input__item" value="{{ old('address', $shop->address) }}"/>
                    <div class="error__item">
                        @error('address')
                            <span class="error__message">{{ $message }}</span>
                        @enderror
            ...
            <div class="form__inner">
                <div class="description__label">
                    ...
                    <div id="charCount" class="char-count">
                        {{ strlen(old('description', $shop->description)) }}/400(文字数)
                    </div>
                </div>
                <div>
                    <textarea name="description" id="description" rows="8" maxlength="400" class="description_text">{{ old('description', $shop->description) }}</textarea>
                ...
                <div class="card">
                    ...
                    <div class="card__item">
                        <div class="shop__name">
                            <p id="name__preview">{{ old('name', $shop->name) }}</p>
                        </div>
                        <div class="text__box">
                            <p id="area__preview" class="area">#{{ old('area_id', $shop->area->name) }}</p>
                            <p id="genre__preview" class="genre">#{{ old('genre_id', $shop->genre->name) }}</p>
                        </div>
                    </div>
                    <div class="card__btn">
                ...
                <div class="shop__detail">
                    <div class="left__header">
                        <div class="detail__ttl">
                            ...
                            <p class="detail__name">{{ old('name', $shop->name) }}</p>
                        </div>
                    </div>
